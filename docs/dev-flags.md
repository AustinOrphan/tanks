...
| `blockedFire` | `blockedFire` | `haptic` | `null` | Plays an experimental cue when the active-shell cap refuses a shot; the shipped default is silent. Issue #356 compares several treatments before adopting one. |
